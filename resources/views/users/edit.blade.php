                ...
                <div class="card-body">
                    ...
                    <form  method='post' action="{{ route('user.update','test') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_name" autofocus class="form-control" value="{{ old('user_name',$user->user_name) }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" autofocus class="form-control" value="{{ old('password_confirmation') }}">
                        </div>
